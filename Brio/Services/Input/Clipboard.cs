...
//
// Some of the code found in this file is based on Functions.cs from OtterGui (Made by https://github.com/Ottermandias)
// https://github.com/Ottermandias/OtterGui/blob/f354444776591ae423e2d8374aae346308d81424/Functions.cs
//
//
...
public static class Clipboard
{
    ...
    public static bool DrawCopyPastePopup<T>(ref T data, byte version = 1)
    {
        using var popup = ImRaii.Popup("CopyPastePopup");
        if(popup.Success)
        {
