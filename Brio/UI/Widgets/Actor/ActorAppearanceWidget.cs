...
{
    public override string HeaderName => capability.Actor.IsProp ? "更改道具" : "外观";
    ...
    private void DrawPropLoadAppearance()
    {
        ...
        if(ImBrio.FontIconButton("attachweapon", FontAwesomeIcon.Retweet, "重新加载道具"))
        {
    ...
    {
        if(ImBrio.FontIconButton("load_npc", FontAwesomeIcon.PersonArrowDownToLine, "加载NPC外观"))
        {
    ...
    {
        var toggele = Capability.IsHidden ? "显示" : "隐藏";
